...
{cmd:ipachecktextaudit} requires an input dataset generated by {help ipasctocollate}. 
...
{pstd}
{opt outfile(varname)} specifies Excel workbook to export the text audit report into. 
